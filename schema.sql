...
CREATE DATABASE IF NOT EXISTS BallerStats;
USE BallerStats;
...
-- Sample player stats
INSERT INTO player_stats (player_id, game_id, points, assists, rebounds, steals, blocks, field_goals_made, field_goals_attempted, 
three_pointers_made, three_pointers_attempted, free_throws_made, free_throws_attempted) VALUES
-- Game 1 stats
...
CREATE USER IF NOT EXISTS 'BallerStats-Admin'@'localhost' IDENTIFIED BY 'Baller-Admin123';
GRANT ALL PRIVILEGES ON BallerStats.* TO 'BallerStats-Admin'@'localhost';
FLUSH PRIVILEGES;
